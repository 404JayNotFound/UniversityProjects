...
{
    // Represents the details of the radio station
    public class RadioStation
    {
        // Backing fields for the station properties
        ...
        // Constructors for creating radio station instances
        public RadioStation() { }

        public RadioStation(string stationName, bool hasTravelInfo,
                            string radioText, double baseFrequency,
                            double alternativeFrequency)
        {
        ...
        public string StationName
        {
            ...
            set
            {
                if (string.IsNullOrWhiteSpace(value))
                    throw new ArgumentException("Station name cannot be empty."); // Empty or whitespace catch
        ...
        {
            get => _radioText;
            set => _radioText = value?.Trim() ?? string.Empty; // Null or whitespace catch
        }
        ...
        // For debugging; Displays station name, base frequency, and radio text
        public override string ToString() => $"{StationName} [{BaseFrequency} MHz] — {RadioText}";
        }
}